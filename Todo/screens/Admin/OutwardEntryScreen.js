...
const OutwardEntryScreen = props => {
    ...
    const outwardData = useSelector(state => state.outwardtransactions.record);
    ...
    const fetchAllData = async (id) => {
        try {
            ...
            await dispatch(outwardAction.getData(id));
            setIsLoading(false);
        } catch (err) {
            setIsLoading(false);
    ...
    useEffect(() => {
        if (outwardData != null) {
            formValues['id'] = outwardData.id;
            formValues['warehouse_id'] = outwardData.warehouse_id;
            formValues['company_name'] = outwardData.company_name;
            formValues['address'] = outwardData.address;
            formValues['item_name'] = outwardData.item_name;
            formValues['empty_weight'] = outwardData.empty_weight;
            formValues['gross_weight'] = outwardData.gross_weight;
            formValues['net_weight'] = outwardData.net_weight;
            formValues['vehicle_no'] = outwardData.vehicle_no;
            formValues['vehicle_in_time'] = outwardData.vehicle_in_time;
            formValues['vehicle_out_time'] = outwardData.vehicle_out_time;
            formValues['driver_name'] = outwardData.driver_name;
            formValues['driver_mobile'] = outwardData.driver_mobile;
            formValues['remarks'] = outwardData.remarks;
        }
    }, [outwardData]);
