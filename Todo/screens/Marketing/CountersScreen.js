            ...
            <FlatList
                ...
                renderItem={({ item, index }) => (
                    <CardData
                        index={index}
                        data={item}
                        titles={['name', 'mobile', 'store code', 'city', 'state', 'address']}
                        fields={['name', 'mobile', 'store_code', 'city', 'state_name', 'address']}
                        hasActions={true}
                        actions={[editClickHandler]}
                        actionIcons={[ActionIcons.Edit]}
                        actionIconColors={[ActionIconColors.Edit]}
                    />
                )}
            />
        </View>
