...
const InwardDetailScreen = props => {
    ...
    useEffect(() => {
        ...
        props.navigation.setOptions({ title: 'Inward Details' });
        ...
        <ScrollView keyboardShouldPersistTaps="handled">
            <View style={styles.container}>
                <DetailsViewer
                    ...
                    captions="Entry Date,Vendor,Address,Total Drums,Total Quantity (kg),Sample Taken,Vehicle No,Driver Name,
                                Driver Mobile,Remarks"
                    keys="entry_date,firm_name,address,total_drums,total_volume,sample_taken_string,vehicle_no,driver_name,
