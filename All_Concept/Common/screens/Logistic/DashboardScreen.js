...
const DashboardScreen = props => {
    ...
    return (
        <ScrollView stickyHeaderIndices={[3]}>
            ...
            <View style={styles.dataRow}>
                <DataThumbnail title="Open Pickup Request Count" value={counters.OpenRequests} style={{ backgroundColor: Colors.thumbnailColor3 }} />
                <DataThumbnail title="Today Picked Up Quantity" unit="kg" value={counters.TodayPickedQty} style={{ backgroundColor: Colors.thumbnailColor4 }} />
            </View>

            <View style={styles.dataRow}>
                <DataThumbnail title="Stock Available At Field" unit="kg" value={counters.FieldStock} style={{ backgroundColor: Colors.thumbnailColor5 }} />
                <DataThumbnail title="Stock Available In Warehouses" unit="kg" value={counters.WarehouseStock} style={{ backgroundColor: Colors.thumbnailColor6 }} />
            </View>
