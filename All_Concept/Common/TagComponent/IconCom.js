...
export const AnyIcon = (props) => <Icon name={props.name} size={props.size} style={props.style} onPress={props.onPress} />
...
export const EmailIcon = (props) => <Icon name="email" size={props.size} style={props.style} onPress={props.onPress} />

// menufold
// export const FacebookButton = <Icon.Button name="login" backgroundColor="#3b5998" onPress={() => alert('Login with Facebook')}> Login with Facebook</Icon.Button>
